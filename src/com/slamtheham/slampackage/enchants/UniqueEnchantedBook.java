...
public class UniqueEnchantedBook {
	private UniqueEnchantments enchantment;
	private int power;
	private int amount;
	...
	public UniqueEnchantedBook(UniqueEnchantments enchantment, Integer power) {
	...
	public UniqueEnchantments getEnchantment() {
	...
	public ItemStack buildBook() {
		...
		String name = Utils.cc("&e") + Utils.cc(enchantment.getName()) + convertPower(power);
