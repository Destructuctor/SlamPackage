...
public class SimpleEnchantedBook {
	private SimpleEnchantments enchantment;
	private int power;
	private int amount;
	 ...
	 * 
	 * @param enchantment
	 *            The enchantment that you choose
	 * @return Enchantments
	 */

	public SimpleEnchantedBook(SimpleEnchantments enchantment, Integer power) {
	...
	public SimpleEnchantments getEnchantment() {
	...
	public ItemStack buildBook() {
		...
		String name = Utils.cc("&7") + Utils.cc(enchantment.getName().replaceAll("_", " ")) + " " + convertPower(power);
		List<String> lore = new ArrayList<String>();
		
		for (String m : enchantment.getDesc()) {
			
		
			lore.add(Utils.cc("&7" + m));
