...
public class HeroicEnchantedBook {
	...
	public HeroicEnchantedBook(HeroicEnchantments enchantment, Integer power) {
	...
	public ItemStack buildBook() {
		...
		String name = Utils.cc("&1") + Utils.cc(enchantment.getName()) + convertPower(power);
