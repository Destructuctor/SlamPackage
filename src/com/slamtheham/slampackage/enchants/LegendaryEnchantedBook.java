...
public class LegendaryEnchantedBook {
	private HeroicEnchantments enchantment;
	private int power;
	private int amount;
	...
	public LegendaryEnchantedBook(HeroicEnchantments enchantment, Integer power) {
	...
	public HeroicEnchantments getEnchantment() {
	...
	public ItemStack buildBook() {
		...
		String name = Utils.cc("&6") + Utils.cc(enchantment.getName()) + convertPower(power);
