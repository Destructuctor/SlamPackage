...
public class SoulEnchantedBook {
	private SoulEnchantments enchantment;
	private int power;
	private int amount;
	...
	public SoulEnchantedBook(SoulEnchantments enchantment, Integer power) {
	...
	public SoulEnchantments getEnchantment() {
	...
	public ItemStack buildBook() {
		...
		String name = Utils.cc("&c") + Utils.cc(enchantment.getName()) + convertPower(power);
