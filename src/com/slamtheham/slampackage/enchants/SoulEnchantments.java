...
public enum SoulEnchantments {
	...
	String Desc;
	String Level;
	private static HashMap<SoulEnchantments, String> customNames = new HashMap<SoulEnchantments, String>();
	private static HashMap<SoulEnchantments, String> bookColors = new HashMap<SoulEnchantments, String>();
	private static HashMap<SoulEnchantments, String> enchantColors = new HashMap<SoulEnchantments, String>();
	private static HashMap<SoulEnchantments, Boolean> active = new HashMap<SoulEnchantments, Boolean>();
	private static HashMap<SoulEnchantments, List<String>> enchantDesc = new HashMap<SoulEnchantments, List<String>>();
