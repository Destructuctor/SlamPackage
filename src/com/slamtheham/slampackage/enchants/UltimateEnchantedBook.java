...
public class UltimateEnchantedBook {
	private UltimateEnchantments enchantment;
	private int power;
	private int amount;
	...
	public UltimateEnchantedBook(UltimateEnchantments enchantment, Integer power) {
	...
	public UltimateEnchantments getEnchantment() {
	...
	public ItemStack buildBook() {
		...
		String name = Utils.cc("&a") + Utils.cc(enchantment.getName()) + convertPower(power);
