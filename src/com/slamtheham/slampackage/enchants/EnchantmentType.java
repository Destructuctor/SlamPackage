...
public enum EnchantmentType {
	...
	TOOL("Tool", isTool()),
	ALL("All", isAll()),
	TOOLS_AND_WEAPONS("Tools and Weapons", isToolsAndWeapons()),
	BOOTS_AND_HELMETS("Boots and Helmets", isBootsAndHelmets()),
	SWORDS_AND_BOWS("Swords and Bows", isBootsAndHelmets());
	private String name;
	...
	private static ArrayList<Material> isBootsAndHelmets() {
	...
	private static ArrayList<Material> isToolsAndWeapons() {
		ArrayList<Material> ma = new ArrayList<Material>();
	...
	private static ArrayList<Material> isSwordAndBow() {
		ArrayList<Material> ma = new ArrayList<Material>();
		ma.add(Material.WOOD_SWORD);
		ma.add(Material.STONE_SWORD);
		ma.add(Material.IRON_SWORD);
