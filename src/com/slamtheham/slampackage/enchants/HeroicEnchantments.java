...
public enum HeroicEnchantments {
	MASTER_INQUISITIVE("Master_Inquisitive", EnchantmentType.SWORD, Arrays.asList("Massively increases EXP drops from mobs. Requires Inquisitive IV enchant on item to apply. Cannot be black-scrolled."), "Heroic"),
	GODLY_OVERLOAD("Godly_Overload", EnchantmentType.ARMOR, Arrays.asList("A very large permanent increase in hearts. Requires Overload III enchant on item to apply. Cannot be black-scrolled."), "Heroic"),
	PLANETARY_DEATHRBINGER("Planetary_Deathbringer", EnchantmentType.ARMOR, Arrays.asList("An increased chance to deal 2.5x damage. Requires Deathbringer III enchant on item to apply. Cannot be black-scrolled."), "Heroic"),
	DIVINE_ENLIGHTENED("Divine_Enlightened", EnchantmentType.ARMOR, Arrays.asList("High chance of healing lots of HP while taking damage. Requires Enlighted III enchant on item to apply. Cannot be black-scrolled."), "Heroic");
	...
	private HeroicEnchantments(String name, EnchantmentType type, List<String> desc, String level) {
		Name = name;
		Type = type;
		Desc = desc;
		Level = level;
	...
	public void load() {
		for(HeroicEnchantments en : values()) {
